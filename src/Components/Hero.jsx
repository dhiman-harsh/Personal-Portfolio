        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-6 md:gap-10 my-6 md:my-20">
            <div className="top flex items-start flex-col gap-6 md:flex-row md:gap-12">
                ...
                <div className="px-4 md:px-0">
                    <div className={`type text-lg md:text-xl font-medium ${theme == 'light' ? 'text-[#555]' : 'text-[#aaa]'}`}>Hello, I am</div>
                    <div className={`type text-2xl md:text-3xl font-medium ${theme == 'light' ? 'text-[#111]' : 'text-[#eee]'}`}>Harsh Dhiman</div>
                    <div className={`type text-3xl md:text-4xl font-semibold my-2 ${theme == 'light' ? 'text-[#000]' : 'text-[#fff]'}`}>A Front End Developer</div>
                    <div className={`max-w-[360px] ${theme == 'light' ? 'text-[#555]' : 'text-[#aaa]'}`}>

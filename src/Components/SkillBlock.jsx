const SkillBlock = ({value, skill}) => {
    return (
        <div className="bg-[#222] flex flex-col gap-2 items-center rounded-sm py-2 px-4 h-40 justify-center border border-neutral-600 hover:scale-105 hover:border-2">
